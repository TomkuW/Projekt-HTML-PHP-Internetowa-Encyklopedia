...
<?php 
  ...
  <?php 
	...
	<hr>
      <h4 >Wszystkie wyniki:</h4>
	  </br>
	  
	  	<?php 
	

	$zapytanie = "SELECT k.nazwa, p.fraza, p.tresc, p.data_dodania, u.imie, u.nazwisko FROM kompedium p, uzytkownik u, kategoria k WHERE u.uzytkownik_id = p.uzytkownik_id AND p.kategoria_id = k.kategoria_id AND p.fraza like '%".$wyrazenie."%' ORDER BY p.fraza ASC LIMIT 5";
